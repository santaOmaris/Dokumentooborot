```sql
-- Создаем схему, чтобы изолировать данные IAM от других сервисов
CREATE SCHEMA IF NOT EXISTS iam_schema;
SET search_path TO iam_schema;

-- ==============================================================================
-- 1. ТАБЛИЦА ОТДЕЛОВ (Покрывает UC-15: Иерархия отделов)
-- ==============================================================================
...
-- ==============================================================================
-- 2. ТАБЛИЦА ПОЛЬЗОВАТЕЛЕЙ (Покрывает UC-3, UC-5, UC-20, UC-21, UC-22)
-- ==============================================================================
CREATE TABLE users (
    id SERIAL PRIMARY KEY,
    
    -- UC-5 (Авторизация): Логин и хэш пароля (bcrypt)
    email VARCHAR(255) UNIQUE NOT NULL,
    password_hash VARCHAR(255) NOT NULL,
    
    -- UC-3 (Справочник): ФИО сотрудника
